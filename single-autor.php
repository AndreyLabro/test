          ...
          <div class="container">
            <div class="row">
              <div class="col-md-12 col-lg-9">
                <div style="background-image: url(<?php echo has_post_thumbnail() ? get_the_post_thumbnail_url() : wp_get_attachment_image_url( get_site_option_( 'authors::ph_photo' ), 'large' ) ; ?>);" class="about-author--img"></div><a href="<?php echo get_post_type_archive_link( 'autor' ); ?>" class="about-author--all">Все авторы</a>
                <div class="about-author--info">
                  <h2 class="about-author--name"><?php the_title(); ?> <?php the_field('autor_name'); ?></h2>
