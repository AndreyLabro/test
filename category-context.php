...
<div class="td-main-content-wrap">
    <div class="container">
          <div class="row">
            <div class="col-lg-10 col-lg-offset-1" id="context_archive" data-current_page="1" >
              <div id="grid_masonry" class="row" style="position: relative; height: 1950px;">
				
				<?php
				$posts_per_page = get_site_option_( 'context::context_ppp' );
