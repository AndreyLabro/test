		...
		<div class="row margin-top-40">
            <div class="col-xs-12 col-sm-11 col-md-8 col-lg-8">
              ...
              <div class="letter-list">
				<?php
					echo get_abc_by_authors( array( 'format' => '<a class="filter" data-filter=".::ltr::">%s</a>', 'prepend' => '<a class="all filter" data-filter="all">' . __( 'Все', 'newspaper' ) . '</a>', 'full' => 'ru', 'exclude' => array( 'ъ', 'ь' ) ) );
				?>
			  </div>
              <div class="row">
